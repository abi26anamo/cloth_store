...
interface CheckoutFormProps {
  clientSecret: string;
  handleSetPayementSuccess: (val: boolean) => void;
}
...
const CheckoutForm: React.FC<CheckoutFormProps> = ({
  ...
  const { cartTotalAmount, handleClearCart, handleSetPayementIntent } = useCart();
  ...
  return (
    <form action="" onSubmit={handleSubmit} id="payment-form">
      ...
      <AddressElement
        options={{ mode: "shipping", allowedCountries: ["US", "ET"] }}
      />
